...
> 品牌、图标、视觉、UI、交互与技术栈规范。v2.2 · 2026-04-20
...
│        │  文件 | 编辑 | 段落 | 格式 | 视图              │
│        ├──────────────────────────────────┤            │
│  File  │  TabBar (32px, always visible)                  │
│  Tree  ├──────────────────────────────────┤            │
│ (240)  │                                  │            │
│        │         Editor Canvas           │  Outline   │
│        │       (max-width 820px,          │  (220px)   │
│        │        centered)                 │            │
│        │                                  │            │
├────────┴──────────────────────────────────┴────────────┤
...
- **TabBar**：32px，始终显示（flexShrink: 0），支持多文件标签页，显示脏状态指示器（蓝色圆点）
- **File Tree**：默认 240px，可隐藏（`Ctrl+\`），支持右键删除（带确认对话框）
...
- v2.2 · 2026-04-20 · TabBar 常驻、右键删除另存为、移除自动保存、分文件脏状态追踪
