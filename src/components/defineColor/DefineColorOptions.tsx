import { getSaturationLevel, nextSaturation } from '../../services/defineColorSystem/constants';
  ...
  return (
    <div className="dc-options">
      <div className="dc-options-top">
          ...
          <button type="button" className="dc-round-control dc-saturation" aria-label={`切换饱和度，当前${saturationLabel}`} title={`饱和度：${saturationLabel}`} data-testid="define-saturation-cycle" onClick={() => onCommit({ saturation: nextSaturation(settings.saturation) })}>
