...
> **实现状态（2026-07-19）**：本文的根因诊断记录 2026-06-22 的修复前状态。当前已启用 Tauri asset protocol 动态目录授权，打开文档、Word/HTML/PDF 预览和 CM6 预览共享本地图片解析；插入后的图片会在当前编辑器中即时显示。后续维护请以源码和 [`docs/ARCHITECTURE.md`](./ARCHITECTURE.md) 为准。
