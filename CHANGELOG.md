...
- 新增 CM6 编辑器内核 Phase 1/2 骨架：增加实验性 `Cm6MarkdownEditorPane`、统一 Markdown extension 构建入口和编辑器核心接口草案；默认仍使用 Vditor，可通过本地 `typola.editorEngine=cm6` feature flag 验证基础 live preview，包括任务列表、表格、图片、KaTeX 数学公式和 Mermaid 图表。
